...
async def cb_choose(_, cq: CallbackQuery):
    ...
    if query == "gensession":
        return await cq.message.reply_text(
            text="☜ <b>اختر نوع الجلسة التي تريد استخراجها :-</b>\n\n» اذا كنت تستخدم رقم جديد او وهمي فانصحك باستخراج كود بايوجرام لكي تحافظ على حسابك من الحذف\n\n » اذا كان رقمك حقيقي و قديم فاستخرج كود ترمكس",
